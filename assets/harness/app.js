...
如果我明确要复现内置 Qwen 参考配方：已测机型为 i7-13700K、RTX 4080 16 GB、64 GB RAM；已测模型是 Huihui Qwen3.8-27B abliterated GSQ-RCO IQ3_S 与 Original Qwen3.8-27B GSQ-RCO IQ3_S，32K、单并发、MTP 关闭。请让我从对应 Hugging Face 仓库取得完整 GGUF，并从 froggeric/Qwen-Fixed-Chat-Templates 固定提交 855bffc 取得 chat_template.jinja；在伴航里检测引擎、模型入库、一键预览/导入并绑定模板，缺资源时保持待绑定。写作 IQ4_XS 和 64K 以上均不可说成已稳定验收。若硬件不同，请先调整并实测。
